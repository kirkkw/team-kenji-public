...
function checkLogin(){
  ...
  if(uid=="" || uid==null || pass=="" || pass==null){
    ...
    $.getJSON("../orig_a7/json/login.json", function(data){
...
function buildPage(){
  $.getJSON('../orig_a7/json/mainlist.json', function(data){
...
function deletePost(element){
  ...
  var resf2 = element.getAttribute("resf2");
    ...
    $.getJSON('../orig_a7/json/resultslist.json', function(data){
...
function openComments(){
  $.getJSON('../orig_a7/json/comments.json', function(data){
    var commentArray = "";
